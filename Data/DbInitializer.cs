    ...
    public class DbInitializer
    {
        public static void Initialize(LibraryContext context)
        {
            ...
            var publishedbooks = new PublishedBook[]
           {
            ...
            new Customer{CustomerID=1050,Name="Popescu Marcela",BirthDate=DateTime.Parse("09-01-1979")},
            new Customer{CustomerID=1045,Name="Mihailescu Cornel",BirthDate=DateTime.Parse("07-08-1979")},
            ...
            {
            new Order{BookID=1,CustomerID=1050,OrderDate=DateTime.Parse("25-02-2020")},
            new Order{BookID=3,CustomerID=1045,OrderDate=DateTime.Parse("28-09-2020")},
            new Order{BookID=1,CustomerID=1045,OrderDate=DateTime.Parse("28-10-2020")},
            new Order{BookID=2,CustomerID=1050,OrderDate=DateTime.Parse("28-09-2020")},
            new Order{BookID=4,CustomerID=1050,OrderDate=DateTime.Parse("28-09-2020")},
            new Order{BookID=6,CustomerID=1050,OrderDate=DateTime.Parse("28-10-2020")},
            };
